...
class TestCreate:
    def test_is_id_returned(self, unit_repository):
        unit = unit_repository.create(ACCOUNT_DATA)

        assert hasattr(unit, 'id')

    def test_create(self, unit_repository, session):
        unit = unit_repository.create(ACCOUNT_DATA)
    ...
    def test_for_duplicated_name(self, unit_repository):
        unit_repository.create(ACCOUNT_DATA)
...
class TestUpdate:
    def test_for_one_field(self, unit_repository, session):
        unit = unit_repository.create(ACCOUNT_DATA)
...
class TestDelete:
    def test_delete(self, unit_repository, session):
        unit = unit_repository.create(ACCOUNT_DATA)
...
class TestGet:
    def test_get(self, unit_repository, session):
        unit = unit_repository.create(ACCOUNT_DATA)
...
class TestGetList:
    ...
    def test_get_list(self, unit_repository, count_to_create, page, per_page):
        created_units = []
