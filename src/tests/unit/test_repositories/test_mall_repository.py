...
class TestCreate:
    def test_is_id_returned(self, mall_repository):
        mall = mall_repository.create(ACCOUNT_DATA)

        assert hasattr(mall, 'id')

    def test_create(self, mall_repository, session):
        mall = mall_repository.create(ACCOUNT_DATA)
    ...
    def test_for_duplicated_name(self, mall_repository):
        mall_repository.create(ACCOUNT_DATA)
...
class TestUpdate:
    def test_for_one_field(self, mall_repository, session):
        mall = mall_repository.create(ACCOUNT_DATA)
...
class TestDelete:
    def test_delete(self, mall_repository, session):
        mall = mall_repository.create(ACCOUNT_DATA)
...
class TestGet:
    def test_get(self, mall_repository, session):
        mall = mall_repository.create(ACCOUNT_DATA)
...
class TestGetList:
    ...
    def test_get_list(self, mall_repository, count_to_create, page, per_page):
        created_malls = []
